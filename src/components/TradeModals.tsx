...
import { X, Shield, CheckCircle, AlertCircle, FileText, Smartphone, ChevronRight, ChevronDown, Copy } from "lucide-react";
...
// ─── Order Page (after confirming trade) ─────────────────────────────
const OrderPage = ({
  offer,
  activeTab,
  selectedCrypto,
  ...
  return (
    <Overlay onClose={onClose}>
      <div className="w-[800px] max-h-[85vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-border/30">
          <h2 className="text-xl font-bold text-foreground">{isBuy ? "Buy" : "Sell"} {selectedCrypto}</h2>
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-1 mt-1">
                <span className="bg-success text-white text-lg font-bold px-2 py-0.5 rounded">30</span>
                <span className="text-lg font-bold text-foreground">:</span>
                <span className="bg-success text-white text-lg font-bold px-2 py-0.5 rounded">00</span>
              </div>
            </div>
          </div>
          ...
          <ul className="text-sm text-muted-foreground space-y-1 mb-6 list-disc pl-5">
            <li>Please complete payment within the allowed time limit.</li>
            <li>After making the payment using a payment method, click the "completed the payment" button below.</li>
            <li>Note: The order will be automatically canceled if not completed in time.</li>
          </ul>
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">Coin Release</span>
            </div>
          </div>
          ...
          <div className="mb-6">
            <h4 className="flex items-center gap-2 text-sm font-medium text-foreground mb-3">
              <span className="w-2 h-2 rounded-full bg-primary" /> Order Info
            </h4>
            <div className="grid grid-cols-3 gap-4 bg-muted/10 rounded-xl p-4">
              <div>
          ...
          <div className="mb-6">
            <h4 className="flex items-center gap-2 text-sm font-medium text-foreground mb-2">
              <span className="w-2 h-2 rounded-full bg-primary" /> Payment Methods Accepted by the Seller
            </h4>
