    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-background">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="h-14 flex items-center justify-between gap-3 border-b border-border bg-card px-3 md:px-5 sticky top-0 z-30">
            <div className="flex items-center gap-2">
              <SidebarTrigger />
              <div className="hidden md:flex items-center gap-2 ml-3">
                <Search className="h-4 w-4 text-muted-foreground" />
                <Input placeholder="Search admin..." className="h-9 w-72 border-0 bg-muted/40 focus-visible:ring-1" />
              </div>
            </div>
            <div className="flex items-center gap-2">
